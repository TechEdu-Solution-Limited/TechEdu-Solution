...
export default function EditTalentPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    phone: talent.contact.phone,
    linkedin: talent.contact.linkedin,
    location: talent.location,
    roleInterest: talent.roleInterest,
    ...
    graduationYear: talent.education[0]?.year || "",
    gpa: talent.education[0]?.gpa || "",
    ...
    // Status
    coachVerified: talent.coachVerified,
  });
  ...
  return (
    <div className="max-w-4xl mx-auto pt-4 pb-10 px-4">
      ...
      <div className="flex flex-col items-start gap-4 mb-8">
        <Link href={`/dashboard/talent-management/${slug}`}>
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600 mt-2">
            Update {talent.name}'s profile information
          </p>
        </div>
      </div>
