...
const scholarshipCoachSteps = [
  ...
  {
    id: 2,
    title: "Access Strategy Guides & Templates",
    badge: "2",
    side: "right" as const,
  },
  {
    id: 3,
    title: "Upload Your Draft (Optional)",
    badge: "3",
    side: "left" as const,
  },
  {
    id: 4,
    title: "Get Feedback from a Real Coach",
    badge: "4",
    side: "right" as const,
  },
  {
    id: 5,
    title: "Refine, Submit & Track your Wins",
    badge: "5",
    side: "left" as const,
  },
];
...
const features = [
  {
    ...
    description:
      "Personal statement and proposal formats used by funded scholars",
    image: "/assets/certificate-verifiable.webp",
  },
  {
    title: "Review & Feedback Add-On",
    description: "Submit your documents for line-by-line review from an expert",
    image: "/assets/certificate-recognized.webp",
  },
  {
    title: "Scholarship Match Guidance",
    description: "Tips for DAAD, Chevening, Erasmus+, Fulbright, CSC & more",
  ...
  {
    title: "Built to Work With CV Builder",
    description: "Bundle with CV for a complete applicant profile",
