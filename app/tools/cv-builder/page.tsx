  ...
  return (
    <>
      ...
      <CVUploadModal
        ...
        loading={uploadLoading} // <-- this drives the spinner after upload success
      />
      ...
      <RatingModal
        ...
        onStartEditing={() => {
          setRatingOpen(false);
          // e.g. send them into your editor or upsell
          // router.push("/dashboard/cv-builder/template-selection");
          setProOpen(true); // or navigate to builder instead
        }}
      />
    </>
  );
